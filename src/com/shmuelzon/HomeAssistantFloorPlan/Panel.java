...
public class Panel extends JPanel implements DialogView {
    ...
    private static final java.util.Set<String> SUPPORTED_DOMAINS = new java.util.HashSet<>(
        java.util.Arrays.asList("binary_sensor", "light", "switch", "sensor", "cover", "person", "device"));
        ...
        new Thread(() -> {
            try {
                ...
                EventQueue.invokeLater(() -> {
                    ...
                    haEntityCountLabel.setText(entities.size() + " entities, " + controller.getLastDeviceCount() + " devices");
                    updateLastFetchedLabel();
                    checkEntities();
